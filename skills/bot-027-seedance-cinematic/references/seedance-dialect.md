...
and [Prompting Seedance 2](../../../../../kb/wiki/topics/prompting-seedance-2.md), the BOT-027
...
- The bible contract + token discipline: the sibling skills `bot-027-character-bible` (frozen blocks, seed, the bible images) and `bot-027-shotlist` (the time-coded shot-list this skill renders).
