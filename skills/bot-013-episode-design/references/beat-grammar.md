...
2. **CHARACTER_BLOCK** (default; phase 2 may lock a custom one in `character-spec.md`) — "An extremely minimal hand-drawn stick figure: single-stroke arms and legs, a plain circle head, two small dot eyes, a simple curved smile, and a small baseball cap worn slightly tilted. No other facial features, no clothing besides the cap, no fingers — simple line hands. Proportions: head about one fifth of total height, limbs slightly longer than the torso."
