...
## [v1.0.0] — 2026-06-04
### Added
- Initial release (brand-review): adapted from Anthropic's `knowledge-work-plugins` marketing plugin for the SL8 content-marketer bot (BOT-011). Runs on user-provided data, no connectors.
