...
### Fixed
- The bundled audio tracks + source for this feature didn't reach the registry in the v1.2.0–v1.2.2 attempts (the publish wrapper synced to `core-skills/drafts/` while skills-publish reads `core-skills/skills/`). This release ships them intact (registry mp3 md5 == source md5; binary upload verified end-to-end).
